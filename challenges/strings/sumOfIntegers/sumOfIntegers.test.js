...
const sumOfIntegersInString = require("./sumOfIntegers")
...
exampleTests.forEach(([testString, correctAnser]) => test(`returns ${correctAnser}`, () => {
    expect(sumOfIntegersInString(testString)).toEqual(correctAnser)
}))